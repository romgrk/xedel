...
module.exports = class ViewRegistry {
  ...
  //   and must return a subclass of `Gtk.Widget` or `undefined`. If it returns
  ...
  // sequence
  //
  //  1. Is the object an instance of `Gtk.Widget`? If true, return the object.
  //  2. Does the object have a method named `getElement` that returns an
  //     instance of `Gtk.Widget`? If true, return that value.
  //  3. Does the object have a property named `element` with a value which is
  //     an instance of `Gtk.Widget`? If true, return the property value.
  ...
  createView(object) {
    ...
    if (object && typeof object.getElement === 'function') {
      ...
      if (element instanceof Gtk.Widget) {
        return element;
      }
    }

    if (object && object.element instanceof Gtk.Widget) {
